...
//-----------------------------------------------------------------------------
void TouchFader::onGetModuleInfo(TMasterInfo* pMasterInfo, TModuleInfo* pModuleInfo)
{
...
void TouchFader::onAfterQuery(TMasterInfo* pMasterInfo, TModuleInfo* pModuleInfo, int queryIndex)
{
	init_MODE = queryIndex;
}
void TouchFader::onGetParamInfo(int ParamIndex, TParamInfo* pParamInfo)
{
...
void TouchFader::onSetEventAddress(int ParamIndex, UsineEventPtr pEvent)
{
...
void TouchFader::onInitModule(TMasterInfo* pMasterInfo, TModuleInfo* pModuleInfo)
{
	///////////////////////////////// INIT
...
//-----------------------------------------------------------------------------
// Parameters callback
void TouchFader::onCallBack(TUsineMessage* Message)
{
	try
	{
...
void TouchFader::SET_INPUTS_CAPTION(TMode MODE)
{
...
//---------------------------------------------------------------------------------
/////////////////////////////////////////
float TouchFader::GET_IN_VALUE(float in_val)
{   
...
//////////////////////////////////////
void TouchFader::onMouseWheel(TShiftState Shift, int WheelDelta)
{
...
void TouchFader::onMouseDown(TMouseButton MouseButton, TShiftState Shift, float X, float Y)
{
...
void TouchFader::onMouseUp(TMouseButton MouseButton, TShiftState Shift, float X, float Y)
{
	TFParams->X = X;
	TFParams->Y = Y;
...
void TouchFader::onMouseMove(TShiftState Shift, float X, float Y)
{
...
////////////////////////////////////////////////////////
void TouchFader::onCreateSettings()
{
...
void TouchFader::onSettingsHasChanged()
{
...
////////////////// SETTINGS
void TouchFader::GLOBAL_SETTINGS()
{
...
void TouchFader::FADER_SETTINGS()
{
...
void TouchFader::BUTTON_SETTINGS()
{
...
void TouchFader::XYPAD_SETTINGS()
{
...
void TouchFader::ENCODER_SETTINGS()
{
...
void TouchFader::RANGE_FADER_SETTINGS()
{
...
void TouchFader::LISTBOX_SETTINGS()
{
...
void TouchFader::MATRIX_SETTINGS()
{
...
////////////////////////////////
void TouchFader::UPD_MIDI_LEARN()
{
...
///////////////////////////////////////////////////////
void TouchFader::onResize(float W, float H)
{RELAYOUT(W,H);}
////////////////////////////////////////////////// recaliber & graphical Layout settings
void TouchFader::RELAYOUT(float W, float H)
{
	CANVAS_H = H;
	CANVAS_W = W;
	CANVAS_S = fmaxf(H, W);
...
//////////////////////////////////////////////////////////
void TouchFader::IMPORT_COMMA_TEXT()
{
...
///////////////////////////// PRESETS /////////////////////////////
int TouchFader::onGetChunkLen(LongBool Preset)
{
	int ChunkLen = 20;// preset save and recall 5 floats * 4 bytes:  W,X,Y,Z, and Switch values
	return ChunkLen;
}
void TouchFader::onGetChunk(void* chunk, LongBool Preset)
{
...
void TouchFader::onSetChunk(const void* chunk, int sizeInBytes, LongBool Preset)
{
...
void TouchFader::onSetRecordedValue(TPrecision 	X, TPrecision 	Y, TPrecision 	Z)
{
...
void TouchFader::onBlocSizeChange(int 	BlocSize)
{
	USINE_BLOC_SIZE = BlocSize;
}
/////////////////////////////////////////////////////////////////////////
////////////////// DRAW SPECIALS ///////////////////////////////////////
void TouchFader::DRAW_ROUND_PATH(TRectF IN_RECT, LongBool ROUNDED, float ROUND_SIZE, float RATIO, float ROUND_SMOOTHNESS, float OFFSET_X, float OFFSET_Y, bool UNCLOSED, int START_POS, int NB_SEG, bool ONLY_SHORT_SEG)
{
	int to_draw = 0;
...
void TouchFader::DRAW_SHAPE_PATH(TFShape IN_RECT, float OFFSET_X, float OFFSET_Y, bool UNCLOSED, int START_POS, int NB_SEG, bool ONLY_SHORT_SEG)
{
...
void TouchFader::DRAW_PATH_FROM_TO(TPointF P_from, TPointF P_to)
{
	sdkDrawPathStart(); sdkDrawPathMoveTo(P_from); sdkDrawPathLineTo(P_to); sdkDrawPathClose();

}
void TouchFader::DRAW_CIRCLE(TPointF Center, float Radius)
{
	int NBP = 16;
...
void TouchFader::DRAW_QUAD_RING(TPointF MAINS[], TPointF CTRLS[], int size)
{
	sdkDrawPathStart();
...
////////////////// REFLECTION SPECIALS ///////////////////////////////////////////
void TouchFader::RECT_REFLECTIONS(TRectF InRect, bool IS_ROUND, float ROUND_SIZE, float CANVAS_RATIO, float ROUND_SMOOTHNESS, float each, float Hue, float Sat, float opa, int DrawMode)
{
...
void TouchFader::SHAPE_REFLECTIONS(TFShape InRect, float each, TUsineColor COLOR, int DrawMode)
{
...
void TouchFader::BEVEL_REFLECTIONS(TFShape InRect, float opa_in)

{
 ...
 //////////////////////////////////////////////////
 ////////////////////////////////////////////////////
void TouchFader::onSetQuickColor(TUsineColor color)
{
		...
		case DT_Enc_Cursor:
			...
			if (TFItem.IEncoder.SHOW.CURSOR_ && TFItem.IEncoder.ENCODER_LAYOUT_TYPE < 3)
			{
				...
				if (TFItem.IEncoder.FX_SHOW_REFLEXIONS && TFItem.IEncoder.CURSOR_TYPE > 1) //shape cursor reflexion
				{
					...
					TUsineColor COLOR_A, COLOR_A2, COLOR_B;
					float IN_LUM = 0;
...
void TouchFader::onPaint()
{
	...
	if (SHOW_NAME && MODE < MListBox)  //name display
	{
		...
		{
			sdkFillText(TFItem.IFader.ELMT.CAP.RECT, AnsiCharPtr(item_name.c_str()), NAME_COLOR, NAME_SIZE, NAME_IS_BOLD, FALSE, taCenter, taTrailing);
		}
	...
	else if (MODE == MListBox) //LB
	{
		...
		TUsineColor LIST_ITEM_COLOR, LIST_ITEM_BORDER_COLOR;
		int item = 0;
		//int lum_it = 0;
		...
		if (TFItem.IListBox.SHOW.LIST_SCROLLER && !TFItem.IListBox.LISTBOX_INERTIA_MODE)
		{
			...
			if (TFItem.IListBox.LIST_USE_PAGES)
			{
				sdkFillText(TFItem.IListBox.LIST_SCROLLER, AnsiCharPtr(TFItem.IListBox.LIST_PAGE_STRING.c_str()), HSLA(0, 0, 0.05f, 0.5f), 0.03f, TRUE, TRUE, taTrailing, taTrailing, FALSE);
			}
		}//end scroller////////////////////////////////////////////////////////
		...
		if (TFItem.IListBox.SHOW.LIST_ITEM_XFADER  && (TFItem.IListBox.INSIDE.LIST_ACTIVE_ITEM || TFItem.IListBox.INSIDE.LIST_HEADER))  //&& TFItem.IListBox.LISTBOX_SETTING_ITEM
		{
			...
			if (!TFItem.IListBox.LIST_SCROLL_ACTIVE && TFParams->MSDWN)// && TFItem.IListBox.X_MODE)
			{
				...
				if (TFItem.IListBox.SHOW.LIST_HEADER)
				{
					...
					{
						sdkFillText(TFItem.IListBox.LIST_HEADER, AnsiCharPtr(LIST_ITEM_XFADER_VAL_STRING.c_str()), TFItem.IListBox.COLOR.Xfader_Value.OUT, 0.03f, FALSE, FALSE, taTrailing, taCenter, FALSE);
					}
