...
class TouchFader : public UserModuleBase
{
	//-------------------------------------------------------------------------
...
public:
	...
	void onSetQuickColor(TUsineColor color);
	//
	void onProcess();
	//-------------------------------------------------------------------------
	// private members
...
//		float W_01 = 0.5;
	...
	void SHAPE_REFLECTIONS(TFShape InRect, float each, TUsineColor COLOR, int DrawMode);
