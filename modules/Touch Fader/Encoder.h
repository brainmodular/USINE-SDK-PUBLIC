...
public:
	...
	TColorUsine SHADOW_COLOR = HSLA(200, 0.0f, 0.1f, 0.5f);
	TColorUsine SHADOW_COLOR_LO = HSLA(200, 0.0f, 0.1f, 0.25f);
	TColorUsine SPECULAR_COLOR_LO;
	TColorUsine SPECULAR_COLOR_VLO;
	TColorUsine SPECULAR_COLOR = HSLA(200, 0.0f, 0.7f, 0.25f);
	TColorUsine SPECULAR_COLOR_HI = HSLA(200, 0.0f, 0.7f, 0.5f);
	...
	*/
	...
	TColorUsine PANEL_COLOR;
	TColorUsine FADER_COLOR;
	TPointF CURSOR_FROM;
	TPointF CURSOR_TO;
	...
	TColorUsine DOTS_COLOR[MAX_LEDS];
	...
	TColorUsine ENCODER_RING_COLOR;
