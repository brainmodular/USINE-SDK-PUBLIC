...
{}
void Preset::Store_Color(string tab, TColorUsine* address, string name)
{
...
void  Preset::SaveToFile(string Path)
{
	...
	for (vector<pair<TColorUsine *, string>>::const_iterator it = CPresets.begin(); it != CPresets.end(); it++)
	{
		outfile << "C" << endl;
		outfile << it->second << endl;
		outfile << *it->first << endl;
