...
//	float ITEM_HUE;
	...
	TRectF VALUE_RECT;
	TColorUsine VALUE_ON_COLOR;
	TColorUsine VALUE_OFF_COLOR;
	TColorUsine NAME_ON_COLOR;
	TColorUsine NAME_OFF_COLOR;
};
// ----------------------------------------------------------------------------
...
public:
	...
	TColorUsine *STRIPES_STRIPES_COLORS;
	...
	TColorUsine *COLOR_Grid_OUT;
	int FX_NB_FLARES;
	TPointF *FX_FLARE;
	TPointF *FX_FLARE_SYM;
	TColorUsine *FX_FLARES_COLORS;
	TColorUsine *FX_FLARES_SYM_COLORS;
	float *FX_FLARES_SIZES;
	float *FX_FLARES_SYM_SIZES;
	TPointF *QUAD_MAINS;
	TPointF *QUAD_CTRL;
	TColorUsine *QUICK_COLOR;
};


//////////////////genir functions
TColorUsine HI_COLOR(TColorUsine COLOR_IN, float Hilight_val); //hilight color
